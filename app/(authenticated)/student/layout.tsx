...
export default async function StudentLayout({
  ...
  return (
    <div className="flex h-screen">
      {/* Impersonation banner — pushes content down */}
      {isImpersonating && (
      ...
      <div className={`flex h-screen w-full ${isImpersonating ? "pt-10" : ""}`}>
        ...
        <aside className="w-64 flex-shrink-0 border-r border-gray-200 bg-white flex flex-col">
          ...
          <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <NavLink href="/student/milestones">Milestones</NavLink>
            <NavLink href="/student/team">My Team</NavLink>
            <NavLink href="/student/score">Score</NavLink>
            <NavLink href="/student/financials">Financials</NavLink>
            <NavLink href="/student/materials">Materials</NavLink>
            <NavLink href="/student/grades">Grades</NavLink>
          </nav>
